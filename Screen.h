...
public :
	...
	void setColor(int r, int c, int pixelSize, int red, int green, int blue); //set warna layar pada koordinat r,c 
	void setColor(int r, int c, int pixelSize, Color C); //set warna layar pada koordinat r,c 
